...
int main()
{
    ...
    do
    {
        ...
        cleare(); // cross-platform console clear
...
{
#ifdef _WIN32
    std::system("cls"); // {Link: Use system("cls") on Windows https://www.mech.kumamoto-u.ac.jp/Info/lab/ape/mori/dark/others-j.files/others.files/tutorial.pdf}
#else
